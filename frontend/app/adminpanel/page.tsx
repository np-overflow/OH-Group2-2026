...
export default function HomePage() {
  ...
  return (
    // <div className="p-8 h-screen relative flex flex-row items-center justify-center">
    <BackContinueButtonContainer onContinue={() => {
      ...
      <div className="h-screen relative flex items-center justify-center">
        <div className="p-8  flex flex-col items-center font-geist gap-4 bg-radial from-[#7E83D3] to-[#F9F9FF] to-50%">
          <h1 className="text-4xl font-bold">Welcome to the Digital Photobooth!</h1>
          <img
            src={
          ...
          <div className="flex gap-20">
            <p>Made with ❤️ by NP Overflow</p>
            {/* <MenuButton
